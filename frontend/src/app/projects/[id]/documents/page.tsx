...
export default function ProjectDocumentsPage() {
    ...
    const fetchData = async (token: string) => {
        try {
            ...
            try {
                const typesRes = await axios.get(`http://localhost:3001/api/documents/types`, { headers });
    ...
    const toggleRequiredDocument = async (docTypeId: string) => {
        try {
            ...
            const res = await axios.post(`http://localhost:3001/api/projects/${id}/required-documents`,
